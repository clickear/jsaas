 ...
 */
public class DicCheckListTag extends TagSupport{
	/**
	 * 
	 */
	...
	public int doStartTag() throws JspException{
		...
		try{
			...
			sb.append(" class=\"mini-checkboxlist\"");
			sb.append(" repeatLayout=\"table\" repeatDirection=\"vertical\"");
			...
			sb.append(" url=\"").append(request.getContextPath()).append("/sys/core/sysDic/listByTreeId.do?treeId=")
			.append(sysTree.getTreeId()).append("\"/>");
