				...
				<table class="table-detail column_2_m" cellspacing="1" cellpadding="0">
					...
					<tr>
						...
						<td colspan="3">
							<input 
       						...
       						/>
       						<a  class="mini-button" iconCls="icon-edit" plain="true" onclick="setValueNull">置空</a>
						</td>
					</tr>
					<tr>
						<th>需　　求 </th>
						<td colspan="3">
							<input 
								...
								value="${planTask.reqId}" 
							 	text="${reqSubject}"
						 	/><a  class="mini-button" iconCls="icon-edit" plain="true" onclick="setMgrValueNull">置空</a>
						</td>
					</tr>
					<tr>
						<th>
					...
					<th>人员选择</th>
						<td>
							...
							/></td>
						<th><input id="ownerId" name="ownerId" class="mini-hidden" value="${userId}" /></th>
						<td>
							<input 
								id="exeId" 
								name="exeId" 
