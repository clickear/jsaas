...
<body>
	...
	<div class="mini-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid"
			...
			url="${ctxPath}/oa/product/oaProductDefPara/listData.do" idField="id"
			...
			<div property="columns">
				...
				<div field="prodDefId" width="120" headerAlign="center"
					allowSort="true">参数定义ID</div>
			</div>
		</div>
	</div>
	...
	<redxun:gridScript gridId="datagrid1"
		entityName="com.redxun.oa.product.entity.OaProductDefPara"
		winHeight="450" winWidth="700" entityTitle="产品定义参数"
		baseUrl="oa/product/oaProductDefPara" />
</body>
</html>