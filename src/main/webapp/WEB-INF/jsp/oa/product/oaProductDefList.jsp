...
<div title="产品分类表单" region="center" showHeader="true" showCollapseButton="false">
	<redxun:toolbar entityName="com.redxun.oa.product.entity.OaProductDef" />

	<div class="mini-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid"
			style="width: 100%; height: 100%;" allowResize="false"
			url="${ctxPath}/oa/product/oaProductDef/listData.do"
			idField="prodDefId" multiSelect="true" showColumnsMenu="true"
	...
	<redxun:gridScript gridId="datagrid1" entityName="com.redxun.oa.product.entity.OaProductDef" winHeight="550" winWidth="800" entityTitle="产品分类定义" baseUrl="oa/product/oaProductDef" />
	<script type="text/javascript">
		  ...
		  //删除树节点
		   	...
		   	function treeNodeClick(e){
		   		var node=e.node;
		   		grid.setUrl(__rootPath+'/oa/product/oaProductDef/listData.do?treeId='+node.treeId);
		   		grid.load();
		   	}
        </script>
</body>
