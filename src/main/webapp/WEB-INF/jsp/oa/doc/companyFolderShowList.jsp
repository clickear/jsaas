	...
	<div id="layout1" class="mini-layout" style="width: 100%; height: 100%;">
		<div title="center" region="center" bodyStyle="overflow:hidden;" style="border: 0;">
			...
			<div class="mini-splitter" style="width: 100%; height: 100%;" borderStyle="border:0;">
				<div size="270" maxSize="350" minSize="100" showCollapseButton="true">
					<!--Tree-->

					<div id="panel1" class="mini-panel" title="公司文档" iconCls="icon-abstain" style="width: 440px; height: 100%;" showToolbar="true" showCollapseButton="true" showFooter="false" allowResize="true" collapseOnTitleClick="true">
						<!--toolbar-->
						...
						<div property="toolbar" class="toolbar-margin">
							<div id="treetoolbar">
								<a class="mini-button" 
									...
									tyle="border:none;background: #f8f8f8;"
								>展开目录</a> 
								<a 
									class="mini-button" 
									iconCls="icon-up" 
						...
						<!--Tree-->
						<ul id="tree1" class="mini-tree" url="${ctxPath}/oa/doc/docFolder/listCompany.do" style="width: 100%; padding: 5px; height: 100%;" showTreeIcon="true" textField="name" idField="folderId" value="base" expandOnLoad="true" parentField="parent" resultAsTree="0" contextMenu="#treeMenu" ondrawnode="onDrawNode" onnodeselect="onNodeSelect">
						</ul>
