...
<body>
	...
	<redxun:toolbar entityName="com.redxun.oa.doc.entity.DocRight" />

	<div class="mini-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid"
			style="width: 100%; height: 100%;" allowResize="false"
			url="${ctxPath}/oa/doc/docRight/listData.do" idField="rightId"
			...
			<div property="columns">
				...
				<div field="rights" width="120" headerAlign="center"
	...
	<redxun:gridScript gridId="datagrid1"
		entityName="com.redxun.oa.doc.entity.DocRight" winHeight="450"
		winWidth="700" entityTitle="[DocRight]" baseUrl="oa/doc/docRight" />
</body>
</html>