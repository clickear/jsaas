...
<body>
	...
	<redxun:toolbar entityName="com.redxun.oa.info.entity.InfInnerMsg" />

	<div class="mini-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid"
			style="width: 100%; height: 100%;" allowResize="false"
			url="${ctxPath}/oa/info/infInnerMsg/listData.do" idField="msgId"
			...
			<div property="columns">
				...
				<div field="category" width="120" headerAlign="center"
					allowSort="true">消息分类</div>
				<div field="sender" width="120" headerAlign="center"
	...
	<redxun:gridScript gridId="datagrid1"
		...
		winWidth="700" entityTitle="[InfInnerMsg]"
		baseUrl="oa/info/infInnerMsg" />
</body>
</html>