...
<body>
<!-- 
	<redxun:toolbar entityName="com.redxun.sys.ldap.entity.SysLdapLog" />
	-->
	...
	<div class="mini-fit" style="height: 100%;">
		<div id="datagrid1" class="mini-datagrid"
			...
			url="${ctxPath}/sys/ldap/sysLdapLog/listData.do" idField="logId"
			...
			<div property="columns">
				...
				<div field="logName" width="120" headerAlign="center"
					allowSort="true">日志名称</div>
				<div field="content" width="120" headerAlign="center"
					allowSort="true">日志内容</div>
				<div dateFormat="yyyy-MM-dd HH:mm:ss"  field="createTime" width="120" headerAlign="center"
					allowSort="true">创建时间</div>

				<!-- 
					
					<div field="startTime" width="120" headerAlign="center"
					allowSort="true">开始时间</div>
				<div field="endTime" width="120" headerAlign="center"
					allowSort="true">结束时间</div>
				<div field="runTime" width="120" headerAlign="center"
					allowSort="true">持续时间</div>
				<div field="status" width="120" headerAlign="center"
					allowSort="true">状态</div>
				<div field="syncType" width="120" headerAlign="center"
					allowSort="true">同步类型</div>
	...
	<redxun:gridScript gridId="datagrid1"
		entityName="com.redxun.sys.ldap.entity.SysLdapLog" winHeight="450"
		winWidth="700" entityTitle="LDAP日志" baseUrl="sys/ldap/sysLdapLog" />
</body>
</html>