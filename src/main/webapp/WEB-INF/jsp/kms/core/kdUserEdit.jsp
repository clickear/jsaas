		...
		<form id="form1" method="post">
			<div class="form-inner">
				...
				<table class="table-detail column_2_m" cellspacing="1" cellpadding="0">
					...
					<tr>
						...
						<td><input name="userType" value="${kdUser.userType}" valueField="id" textField="text" class="mini-combobox" style="width: 50%" required="true" data="[{id:'DOMAIN',text:'领域专家'},{id:'PERSON',text:'个人专家'}]" /></td>
						<th>
							<span class="starBox">
					...
					<tr>
						...
						<td>
						<input id="knSysId" name="knSysId" value="${kdUser.knSysTree.treeId}"  text="${kdUser.knSysTree.name}"  style="width: 180px;" class="mini-buttonedit" onbuttonclick="onButtonEdit" allowInput="false" required="true" />
						</td>
						<th>
							<span class="starBox">
						...
						<td>
						<input id="reqSysId" name="reqSysId" value="${kdUser.reqSysTree.treeId}"  text="${kdUser.reqSysTree.name}"  style="width: 180px;" class="mini-buttonedit" onbuttonclick="onButtonEdit" allowInput="false" required="true" />
						</td>
					</tr>
			...
			<%-- 			<th>序号 </th>
					...
					<tr>
						...
						<td colspan="3"><input id="link-user" required="true" name="link-user" value="${kdUser.user.userId}"  text="${kdUser.user.fullname}"  style="width: 180px;" class="mini-buttonedit" onbuttonclick="chooseUser" /></td>
					</tr>
