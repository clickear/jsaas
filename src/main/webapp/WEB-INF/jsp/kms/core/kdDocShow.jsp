...
<body style="min-width: 1600px;">
	...
	<div id="topButton" style="float: right; margin-top: 5px;">
		<a class="topButton" onclick="favorite()">收藏</a> 
		<a class="topButton" onclick="remDoc()">推荐</a> 
		<a style="text-decoration: none;" id="edit" class="topButton" href="${ctxPath}/kms/core/kdDoc/edit.do?pkId=${kdDoc.docId}">编辑</a> 
...
<!-- 	<hr style="height: 4px; border: none; border-top: 2px groove #CFCFCF;" /> -->
	<div style="font-size: 10px; margin-left: 70px;">首页 > 知识仓库 > ${treeType}</div>

	<!-- 右边基本信息 -->
	<dl class="rightC">
		<dt>基本信息</dt>
		<dd>
			<span style="font-style: italic; font-weight: 500; font-size: 30px; margin-left: 10px; margin-top: 10px; color: #FF6C00;">${kdDoc.compScore}</span> 
			<span id="readOnly-demo" style="margin-left: 10px; margin-top: 10px;"></span>
		</dd>
		<dd>
	...
	<div class="contentBox">
		...
		<div class="contentTitle">
			...
			<div id="hidebutton" style="text-align: right; margin-bottom: 5px; color: blue;cursor: pointer;" onclick="hide('context','showbutton','hidebutton')">收起正文</div>
			<div id="showbutton" style="text-align: right; margin-bottom: 5px; color: blue;cursor: pointer;" onclick="show('context','showbutton','hidebutton')">展开正文</div>
		</div>
		<div id="context" style="margin-left: 5px; margin-right: 5px; min-height: 300px; text-align: left; vertical-align: top">${kdDoc.content}</div>
	</div>
	...
	<div style="width: 50%; margin-left: 100px; margin-right: 40%; margin-top: 30px; text-align: left;">
		<div style="font-weight: bold; font-size: 15px; color: #3E9CEF; border-bottom-color: #A7D3FB; border-bottom-width: 1px; border-bottom-style: solid;">
			<span style="margin-left: 15px; margin-bottom: 5px;">附件</span> 
			<span id="fileHide" style="height: 20px; width: 20px; float: right;cursor: pointer; background-image: url('/jsaas/styles/icons/arrowUp.png'); background-repeat: no-repeat;" onclick="hide('file','fileShow','fileHide')"></span> 
			<span id="fileShow" style="height: 20px; width: 20px; float: right;cursor: pointer; background-image: url('/jsaas/styles/icons/arrowDown.png'); background-repeat: no-repeat;" onclick="show('file','fileShow','fileHide')"></span>
		</div>
		<div id="file">
	...
	<div style="width: 50%; margin-left: 100px; margin-right: 40%; margin-top: 30px; text-align: left;">
		<div style="font-weight: bold; font-size: 15px; color: #3E9CEF; border-bottom-color: #A7D3FB; border-bottom-width: 1px; border-bottom-style: solid;">
			...
			<span id="cmmtHide" style="height: 20px; width: 20px; float: right;cursor: pointer; background-image: url('/jsaas/styles/icons/arrowUp.png'); background-repeat: no-repeat;" onclick="hide('cmmt','cmmtShow','cmmtHide')"></span> 
			<span id="cmmtShow" style="height: 20px; width: 20px; float: right;cursor: pointer; background-image: url('/jsaas/styles/icons/arrowDown.png'); background-repeat: no-repeat;" onclick="show('cmmt','cmmtShow','cmmtHide')"></span>
		</div>
		<div id="cmmt">
			<div id="myCmmt">
				...
				<div style="margin-left: 6px; margin-top: 10px; margin-bottom: 10px; width: 900px;">
					<textarea id="content" name="content" cols=100 rows=4>写的不错，好评！</textarea>
				...
				<div id="notice" name="notice" class="mini-checkbox" readOnly="false" text="通知文档创建者" style="margin-top: 5px; margin-left: 10px;"></div>
			</div>
	...
	<div style="width: 50%; margin-left: 100px; margin-right: 40%; margin-top: 30px; text-align: left;">
		<div style="font-weight: bold; font-size: 15px; color: #3E9CEF; border-bottom-color: #A7D3FB; border-bottom-width: 1px; border-bottom-style: solid;">
			...
			<span id="remHide" style="height: 20px; width: 20px; float: right;cursor: pointer; background-image: url('/jsaas/styles/icons/arrowUp.png'); background-repeat: no-repeat;" onclick="hide('rem','remShow','remHide')"></span> 
			<span id="remShow" style="height: 20px; width: 20px; float: right;cursor: pointer; background-image: url('/jsaas/styles/icons/arrowDown.png'); background-repeat: no-repeat;" onclick="show('rem','remShow','remHide')"></span>
		</div>
		<div id="rem">
			<div id="myRem">
				<div style="margin-left: 5px; margin-top: 10px;">
					<div style="font-weight: 600; color: #545454; font-size: 15px;">
						...
						<a class="mini-button" style="width: 110px; margin-left: 10px; margin-top: 5px;" iconCls="icon-addMsgPerson" onclick="addPerson(remReceive)">新增用户</a> 
						<a class="mini-button" style="width: 110px; margin-left: 10px; margin-top: 5px;" iconCls="icon-addMsgGroup" onclick="addGroup(remReceive)">新增用户组</a> 
	...
	<div style="width: 50%; margin-left: 100px; margin-right: 40%; margin-top: 30px; text-align: left;">
		<div style="font-weight: bold; font-size: 15px; color: #3E9CEF; border-bottom-color: #A7D3FB; border-bottom-width: 1px; border-bottom-style: solid;">
			...
			<span id="readHide" style="height: 20px; width: 20px; float: right;cursor: pointer; background-image: url('/jsaas/styles/icons/arrowUp.png'); background-repeat: no-repeat;" onclick="hide('read','readShow','readHide')"></span> 
			<span id="readShow" style="height: 20px; width: 20px; float: right;cursor: pointer; background-image: url('/jsaas/styles/icons/arrowDown.png'); background-repeat: no-repeat;" onclick="show('read','readShow','readHide')"></span>
		</div>
		<div id="read" style="margin-top: 5px; margin-bottom: 10px; height: 340px;">
			<div id="reader" class="mini-datagrid" style="width: 100%; height: auto;" allowResize="false" url="${ctxPath}/kms/core/kdDocRead/getReader.do?docId=${kdDoc.docId}" idField="Id" multiSelect="true" showColumnsMenu="true" sizeList="[5,10,20,50,100,200,500]" pageSize="10" allowAlternating="true">
				<div property="columns">
					<div field="name" width="120" headerAlign="center" allowSort="true">用户名</div>
					<div field="status" width="120" headerAlign="center" allowSort="true">文档状态</div>
	...
	<div style="width: 50%; margin-left: 100px; margin-right: 40%; margin-top: 30px; text-align: left;">
		<div style="font-weight: bold; font-size: 15px; color: #3E9CEF; border-bottom-color: #A7D3FB; border-bottom-width: 1px; border-bottom-style: solid;">
			...
			<span id="hisHide" style="height: 20px; width: 20px; float: right; background-image: url('/jsaas/styles/icons/arrowUp.png'); background-repeat: no-repeat;" onclick="hide('his','hisShow','hisHide')"></span> 
			<span id="hisShow" style="height: 20px; width: 20px; float: right; background-image: url('/jsaas/styles/icons/arrowDown.png'); background-repeat: no-repeat;" onclick="show('his','hisShow','hisHide')"></span>
		</div>
	...
	<script type="text/javascript">
		...
		function newVersion() {
			$.ajax({
				...
				success : function() {
					window.location.href = "${ctxPath}/kms/core/kdDoc/edit.do?pkId=" + pkId;
				}
			});
		}
