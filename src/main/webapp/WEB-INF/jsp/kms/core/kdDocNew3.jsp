		...
		<div class="shadowBox90">
			<table style="width: 100%;" class="gridtable" cellspacing="1" cellpadding="0">
				...
				<tr>
					...
					<td style=""><input id="storePeroid" name="storePeroid" value="${kdDoc.storePeroid}" class="mini-spinner" minValue="0" maxValue="20" />&nbsp;年（0年表示永不过期，文档到达过期时间后转为过期文档）</td>
				</tr>
			</table>
		</div>
		</form>
...
<!-- 	<hr style="margin-top: 30px;"> -->
	<div style="margin-top: 20px; margin-left: 40%;">
		<a class="topButton" style="height: 40px; width: 90px; line-height: 40px; text-decoration: none;" href="${ctxPath}/kms/core/kdDoc/new2.do?docId=${param['docId']}">上一步</a> <a class="topButton" style="height: 40px; width: 90px; line-height: 40px; text-decoration: none;" onclick="savePost3()">下一步</a>
	</div>
