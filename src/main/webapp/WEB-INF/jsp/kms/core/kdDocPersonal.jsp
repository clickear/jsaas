...
<body style="min-width: 1600px;">
			...
			<div class="selectNumberScreen">
				<div id="selectList" class="screenBox screenBackground">
					<dl class="listIndex" attr="Q_Type_S_EQ">
						<dt>我的文档知识：</dt>
						<dd>
							<a href="javascript:void(0)" values2="" values1="" attrval="myDoc">我的文档</a> <a href="javascript:void(0)" values2="" values1="" attrval="myCmmt">我点评的</a> <a href="javascript:void(0)" values2="" values1="" attrval="myEdit">我可编辑的</a> <a href="javascript:void(0)" values2="" values1="" attrval="myFav">我收藏的</a>
						</dd>
					</dl>
	...
	<div style="margin-left: 400px; margin-right: 150px; height: 100%;">
		<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: auto;" allowResize="false" url="${ctxPath}/kms/core/kdDoc/getAllDoc.do" idField="docId" multiSelect="true" showColumnsMenu="true" sizeList="[5,10,20,50,100,200,500]" pageSize="20" allowAlternating="true" onrowdblclick="showDoc">
	...
	<script type="text/javascript">
		...
		$(".listIndex a ").on("click", function() {
			...
			var formData = {};
			grid.setUrl("${ctxPath}/kms/core/kdDoc/personalSearchDoc.do?");
