...
<html>
<head>
	<title>流程全局事件或节点接口调用配置--Restful API调用配置</title>
...
<body>
	...
	<table class="table-detail column_1_m"  cellspacing="1" cellpadding="0" style="width:100%;">
		<caption>调用Restful API 配置</caption>
		<tr>
			<td colspan="2">
		...
		<tr>
			<th>数据提交方式</th>
			<td>
				<input class="mini-combobox" name="submitType" value="POST" data="[{id:'POST',text:'POST'},{id:'PUT',text:'PUT'},{id:'DELDTE',text:'DELETE'},{id:'GET',text:'GET'}]">
			</td>
		</tr>
		<tr>
			<th>输入参数</th>
