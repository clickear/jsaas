		    ...
		    <div title="流程实例列表" region="center" showHeader="false" showCollapseButton="false">
				<div class="titleBar">
					<ul>
						...
						<li>
							<a class="mini-button" iconCls="icon-end" onclick="onEndProcess" >结束实例</a>
						</li>
						<li>
							<a class="mini-button" iconCls="icon-suspend" onclick="onPendingProcess" >挂起实例</a>
						</li>
						<!-- <li>
							<a class="mini-button" iconCls="icon-search" >查询</a>
						</li> -->
						<li>
							<a class="mini-button" iconCls="icon-activate" onclick="onActivateProcess" >恢复实例</a>
						</li>
					...
					<div class="searchBox">
						<form id="searchForm" class="text-distance" style="display: none;">						
							...
							<ul>
								...
								<li>
									<span class="text">状态:</span><input class="mini-combobox" style="width:150px;" name="Q_b.STATUS__S_EQ"
								...
								<li>
									<div class="searchBtnBox">
										...
										<input class="_reset" type="reset" value="重置" onclick="onClear()">
									</div>
								</li>
								<li class="clearfix"></li>
							</ul>
...
/*             	for(var i=0;i<instJson.length;i++){
            	...
            	*/
            	if(record.status=='DRAFTED'){       
	            	s= s + ' <span class="icon-start" title="发起" onclick="startRow(\'' + uid + '\')"></span>';
	            } 
